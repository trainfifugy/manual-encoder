...
try:
    APP_ID = config("5168062", cast=int)
    API_HASH = config("04c049aa96d1cc87920b45b7fb43c0d0")
    BOT_TOKEN = "5058183358:AAEE65GnRhfFi-DLb_3BX7V0m-QB4FRtIr8"
    DEV = 1664850827
    OWNER = config("1956035465")
